---
title: "hdWGCNA (trisomy)"
format: html
---

Author: Carlo Zanetti

Performs hdWGCNA co-expression network analysis on the trisomy microglia dataset. Constructs metacells, selects soft power threshold, builds a TOM-based network, computes harmony-corrected module eigengenes (hMEs), and runs GO enrichment via EnrichrR. Follows the [hdWGCNA basic tutorial](https://smorabit.github.io/hdWGCNA/articles/basic_tutorial.html).

**Inputs:** `output/run1/objects/prelabelled_integrated_rpca.qs2`
**Outputs:** WGCNA Seurat object, module graphs, enrichment PDFs written to `output/run1/wgcna/`
